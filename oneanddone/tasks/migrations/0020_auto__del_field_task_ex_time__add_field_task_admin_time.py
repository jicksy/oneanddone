...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Task.ex_time'
        db.delete_column('tasks_task', 'ex_time')

        # Adding field 'Task.admin_time'
        db.add_column('tasks_task', 'admin_time',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=25, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Task.ex_time'
        db.add_column('tasks_task', 'ex_time',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Deleting field 'Task.admin_time'
        db.delete_column('tasks_task', 'admin_time')
    ...
    models = {
        ...
        'tasks.task': {
            ...
            'admin_time': ('django.db.models.fields.TextField', [], {'max_length': '25', 'blank': 'True'}),
